...
namespace LibraryNumbersToWords9apr2024
{
    public static class NumbersToWords
    {
        ...
        public static string ToWords(this BigInteger number)
        {
            ...
            */
            ...
            Trace.Listeners.Add(new TextWriterTraceListener(File.AppendText($"log{DateTime.Now.ToString("yyyyMddhhmmsstt") + (new Random()).Next()}.txt")));
