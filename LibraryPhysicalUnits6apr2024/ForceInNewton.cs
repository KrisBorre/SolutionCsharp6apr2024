namespace LibraryPhysicalUnits6apr2024
{
    public class ForceInNewton : IForce
    {
        ...
        {
            var result = ForceCalculation.Add(a, b);
            return result;
        }
