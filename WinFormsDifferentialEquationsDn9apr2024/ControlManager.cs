...
using LibraryDifferentialEquationsDn9apr2024;
...
namespace WinFormsDifferentialEquationsDn9apr2024
{
    internal class ControlManager
    {
        ...
        public ControlManager()
        {
            ...
            var problem = new DifferentialEquationsDn9apr2024<double>();
            ...
            LineSeries series1 = new LineSeries { Title = "dn(u,k) with k=0.5" };
            LineSeries series2 = new LineSeries { Title = "derivative of dn" };
