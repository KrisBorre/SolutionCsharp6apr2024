...
using LibraryDifferentialEquationsEllipticFunctions9apr2024;
...
namespace WinFormsDifferentialEquationsEllipticFunctions9apr2024
{
    internal class ControlManager
    {
        ...
        public ControlManager()
        {
            ...
            var problem = new DifferentialEquationsEllipticFunctions9apr2024<double>();
            ...
            LineSeries series2 = new LineSeries { Title = "cn(u,k) with k=0.5" };
            LineSeries series3 = new LineSeries { Title = "dn(u,k) with k=0.5" };
